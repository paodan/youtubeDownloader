#' Download YouTube videos/audios by providing a table of list.
...
videoListDownloadByTable = function(fileList, path, bothVideoAudio = TRUE,
                                    priority = c("mp4", "best", "audio only"),
                                    id = NULL, sleepTime = 10){
  ...
  for(ui in id){
    ...
    youTubeDownload(url = url_ui, path = path, saveFile = file_ui,
